...
css/style.css            Single shared stylesheet, organized into commented sections
                         (reset -> tokens -> base -> header/nav -> homepage sections ->
                         shared components -> footer -> responsive -> inner-page layout)
